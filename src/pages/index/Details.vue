          ...
          <div class="review-version">
              <div class="form-box">
                <div class="article-cont">
                  <div class="title">
                    <h3>{{article.title}}</h3>
                    <p class="cont-info"><span class="data">{{article.date}}</span><span class="types">{{article.type}}</span></p>
                  </div>
              ...
              <div class="list-cont">         
                <div class="cont" v-for="(comment, index) in article.comments" :key="index">
                  <div class="img">
                    <img :src="comment.authorAvator" class="avator-img">
                  </div>
                  <div class="text">
    ...
    data () {
      var article = {
        ...
        contentHtml: `
          ...
          <img src="/static/imgs/1551340747874.jpg">
